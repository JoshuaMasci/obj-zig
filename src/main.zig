...
pub fn main() !void {
    var file = try std.fs.cwd().openFile("sci-fi-cube.obj", std.fs.File.OpenFlags{ .read = true });
    ...
    var mesh = try loadObj(&gpa.allocator, reader, .{});
...
pub fn parseIndex(index_string: []const u8) !Index {
